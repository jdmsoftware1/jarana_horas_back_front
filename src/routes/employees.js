...
// Get all employees (PROTEGIDO - Solo admin)
...
// Create new employee (PROTEGIDO - Solo admin)
...
// Regenerate TOTP secret (PROTEGIDO - Solo admin)
router.post('/:id/regenerate-totp', authMiddleware, adminMiddleware, async (req, res) => {
  try {
    const { id } = req.params;
